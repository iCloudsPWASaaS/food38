<template>
    ...
    <div class="db-card db-tab-div active">
        ...
        <div class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-6"  v-if="itemCategories.length > 0">
...
export default {
    ...
    computed: {
        itemCategories: function () {
            this.modalSortItemCategories = this.$store.getters['itemCategory/lists'];
    ...
    methods: {
        ...
        sortItemCategory: function () {
            ...
            this.$store.dispatch('itemCategory/sortCategory', {form: {category_id: sortedIds}, search: this.props.search}).then((res) => {
                this.list();
            }).catch((err) => {
                alertService.error(err.response.data.message);
            });
